  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (_) => VisionPanelFilterCubit()),
        BlocProvider(create: (_) => InstallationFilterCubit()),
       ...
       BlocProvider(create: (_) => VisionPanelBlocProvider.get().fetchVision()),
       BlocProvider(create: (_) => InstallationBlocProvider.get().getInstallation()),
       BlocProvider(
