...
enum PageMode4 {
  ...
  final String name;
  const PageMode4(this.name);
}

class AppPageView4<T extends PageViewFiltersCubit> extends StatefulWidget {
  const AppPageView4({
    super.key,
    required this.child,
    required this.mode,
  ...
  final Widget child;
  final PageMode4 mode;
  final VoidCallback onNew;
  final Color backgroundColor;
  final String scaffoldBg;

  @override
  State<AppPageView4<T>> createState() => _AppPageView4State<T>();
}

class _AppPageView4State<T extends PageViewFiltersCubit>
    extends State<AppPageView4<T>> {
  bool isTodaySelected = true;

  String get hintText => switch (widget.mode) {
    PageMode4.gateentry => 'Search GI / PO',
    PageMode4.gateexit => 'Search GO / SINV',
    PageMode4.logisticRequest => 'Search LR / SO ID',
    PageMode4.transportConfirmation => 'Search LR / TC',
    PageMode4.vehicleReporting => 'Search VRE / TC',
    PageMode4.loadingConfirmation => 'Search LC / TC',
  };

  Color get bgColor => switch (widget.mode) {
    PageMode4.gateentry => Colors.white,
    PageMode4.gateexit => AppColors.white,
    PageMode4.logisticRequest => const Color(0xFF808080),
    PageMode4.transportConfirmation => AppColors.white,
    PageMode4.vehicleReporting => AppColors.white,
    PageMode4.loadingConfirmation => AppColors.white,
  };
