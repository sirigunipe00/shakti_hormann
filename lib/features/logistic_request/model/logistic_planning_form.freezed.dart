...
LogisticPlanningForm _$LogisticPlanningFormFromJson(Map<String, dynamic> json) {
  return _LogisticPlanningForm.fromJson(json);
}

/// @nodoc
mixin _$LogisticPlanningForm {
  @JsonKey(name: 'name')
  ...
  $LogisticPlanningFormCopyWith<LogisticPlanningForm> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $LogisticPlanningFormCopyWith<$Res> {
  factory $LogisticPlanningFormCopyWith(
    LogisticPlanningForm value,
    $Res Function(LogisticPlanningForm) then,
  ) = _$LogisticPlanningFormCopyWithImpl<$Res, LogisticPlanningForm>;
  @useResult
  $Res call({
...
/// @nodoc
class _$LogisticPlanningFormCopyWithImpl<
  $Res,
  $Val extends LogisticPlanningForm
>
    implements $LogisticPlanningFormCopyWith<$Res> {
  _$LogisticPlanningFormCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$LogisticPlanningFormImplCopyWith<$Res>
    implements $LogisticPlanningFormCopyWith<$Res> {
  factory _$$LogisticPlanningFormImplCopyWith(
    _$LogisticPlanningFormImpl value,
    $Res Function(_$LogisticPlanningFormImpl) then,
  ) = __$$LogisticPlanningFormImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    @JsonKey(name: 'name') String name,
...
/// @nodoc
class __$$LogisticPlanningFormImplCopyWithImpl<$Res>
    extends _$LogisticPlanningFormCopyWithImpl<$Res, _$LogisticPlanningFormImpl>
    implements _$$LogisticPlanningFormImplCopyWith<$Res> {
  __$$LogisticPlanningFormImplCopyWithImpl(
    _$LogisticPlanningFormImpl _value,
    $Res Function(_$LogisticPlanningFormImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$LogisticPlanningFormImpl implements _LogisticPlanningForm {
  const _$LogisticPlanningFormImpl({
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$LogisticPlanningFormImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$LogisticPlanningFormImplCopyWith<_$LogisticPlanningFormImpl>
  get copyWith =>
      __$$LogisticPlanningFormImplCopyWithImpl<_$LogisticPlanningFormImpl>(
        this,
        _$identity,
      );
  ...
  Map<String, dynamic> toJson() {
    return _$$LogisticPlanningFormImplToJson(this);
  }
}

abstract class _LogisticPlanningForm implements LogisticPlanningForm {
  const factory _LogisticPlanningForm({
  ...
  factory _LogisticPlanningForm.fromJson(Map<String, dynamic> json) =
      _$LogisticPlanningFormImpl.fromJson;
