...
class LogisticDetailScreen extends StatelessWidget {
  const LogisticDetailScreen({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    sectionHeader(Icons.local_shipping, "Logistic Request Details"),
                    entryFormTile("Plant Name", "SHM Medchal"),
                    entryFormTile("Logistic Request Number", "Enter LR No."),
                    entryFormTile(
                      "Logistic Request Date",
                      "Enter Date",
