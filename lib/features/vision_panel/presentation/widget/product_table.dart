...
//   bool _canAddItem(CreateVisionPanelState state) {
//     if (state.items.isEmpty) return true;
//     return state.form.name != null &&
...
//     if (result != null) {
//       cubit.addItemFromDialog(productType: result.$1, noOfBoxes: result.$2);
//     }
//   }
// }
...
//     // Once printed, this item's boxes now live in the Image Capture
//     // table below — this row just reflects that it's done.
//     return const Row(
                  ...
                  children: [
                    ...
                    if (state.form.docStatus != 1)
                      Align(
                        ...
                        child: ElevatedButton.icon(
                          onPressed:
                              _canAddItem(state) && !state.isLoading
                                  ? () => _openAddItemDialog(context, cubit)
                                  : null,
