...
abstract class $SalesInvoiceCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'sales_invoice') String? name});
}
...
class _$SalesInvoiceImpl implements _SalesInvoice {
  const _$SalesInvoiceImpl({@JsonKey(name: 'sales_invoice') this.name});
...
abstract class _SalesInvoice implements SalesInvoice {
  const factory _SalesInvoice({
    @JsonKey(name: 'sales_invoice') final String? name,
  }) = _$SalesInvoiceImpl;
