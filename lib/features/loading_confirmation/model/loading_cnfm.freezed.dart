...
LoadingCnfmForm _$LoadingCnfmFormFromJson(Map<String, dynamic> json) {
  return _LoadingCnfmForm.fromJson(json);
}

/// @nodoc
mixin _$LoadingCnfmForm {
  @JsonKey(name: 'name')
  ...
  String? get vehicleReportingEntryVreDate =>
  ...
  String? get arrivalDateAndTime => throw _privateConstructorUsedError;
  @JsonKey(name: 'driver_id_proof')
  String? get driverIdPhoto => throw _privateConstructorUsedError;
  @JsonKey(name: 'loaded_by_user')
  String? get loadedByUser => throw _privateConstructorUsedError;
  @JsonKey(name: 'status')
  String? get status => throw _privateConstructorUsedError;
  @JsonKey(name: 'linked_transporter_confirmation')
  String? get linkedTransporterConfirmation =>
      throw _privateConstructorUsedError;
  ...
  /// Serializes this LoadingCnfmForm to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of LoadingCnfmForm
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $LoadingCnfmFormCopyWith<LoadingCnfmForm> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $LoadingCnfmFormCopyWith<$Res> {
  factory $LoadingCnfmFormCopyWith(
    LoadingCnfmForm value,
    $Res Function(LoadingCnfmForm) then,
  ) = _$LoadingCnfmFormCopyWithImpl<$Res, LoadingCnfmForm>;
  @useResult
  $Res call({
...
/// @nodoc
class _$LoadingCnfmFormCopyWithImpl<$Res, $Val extends LoadingCnfmForm>
    implements $LoadingCnfmFormCopyWith<$Res> {
  _$LoadingCnfmFormCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? loadedByUser = freezed,
    Object? status = freezed,
    Object? linkedTransporterConfirmation = freezed,
    ...
    return _then(
      _value.copyWith(
            ...
            vehicleReportingEntryVreDate:
                freezed == vehicleReportingEntryVreDate
                    ? _value.vehicleReportingEntryVreDate
                    : vehicleReportingEntryVreDate // ignore: cast_nullable_to_non_nullable
                        as String?,
            transporterName:
                freezed == transporterName
                    ...
                    : transporterName // ignore: cast_nullable_to_non_nullable
                        as String?,
            arrivalDateAndTime:
                freezed == arrivalDateAndTime
                    ? _value.arrivalDateAndTime
                    : arrivalDateAndTime // ignore: cast_nullable_to_non_nullable
                        as String?,
            driverIdPhoto:
                freezed == driverIdPhoto
                    ? _value.driverIdPhoto
                    : driverIdPhoto // ignore: cast_nullable_to_non_nullable
                        as String?,
            loadedByUser:
                freezed == loadedByUser
                    ? _value.loadedByUser
                    : loadedByUser // ignore: cast_nullable_to_non_nullable
                        as String?,
            status:
                freezed == status
                    ? _value.status
            ...
            linkedTransporterConfirmation:
                freezed == linkedTransporterConfirmation
                    ? _value.linkedTransporterConfirmation
                    : linkedTransporterConfirmation // ignore: cast_nullable_to_non_nullable
                        as String?,
            vehicleNumber:
...
/// @nodoc
abstract class _$$LoadingCnfmFormImplCopyWith<$Res>
    implements $LoadingCnfmFormCopyWith<$Res> {
  factory _$$LoadingCnfmFormImplCopyWith(
    _$LoadingCnfmFormImpl value,
    $Res Function(_$LoadingCnfmFormImpl) then,
  ) = __$$LoadingCnfmFormImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    @JsonKey(name: 'name') String? name,
...
/// @nodoc
class __$$LoadingCnfmFormImplCopyWithImpl<$Res>
    extends _$LoadingCnfmFormCopyWithImpl<$Res, _$LoadingCnfmFormImpl>
    implements _$$LoadingCnfmFormImplCopyWith<$Res> {
  __$$LoadingCnfmFormImplCopyWithImpl(
    _$LoadingCnfmFormImpl _value,
    $Res Function(_$LoadingCnfmFormImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$LoadingCnfmFormImpl implements _LoadingCnfmForm {
  const _$LoadingCnfmFormImpl({
    @JsonKey(name: 'name') this.name,
    @JsonKey(name: 'owner') this.owner,
    @JsonKey(name: 'creation', defaultValue: '') this.creation,
    @JsonKey(name: 'modified', defaultValue: '') this.modified,
    ...
    @JsonKey(name: 'loaded_by_user') this.loadedByUser,
    @JsonKey(name: 'status') this.status,
    @JsonKey(name: 'linked_transporter_confirmation')
    this.linkedTransporterConfirmation,
    @JsonKey(name: 'vehicle_number') this.vehicleNumber,
    @JsonKey(name: 'driver_contact') this.driverContact,
    @JsonKey(name: 'remarks') this.remarks,
  });

  factory _$LoadingCnfmFormImpl.fromJson(Map<String, dynamic> json) =>
      _$$LoadingCnfmFormImplFromJson(json);
  ...
  @override
  @JsonKey(name: 'driver_id_proof')
  final String? driverIdPhoto;
  @override
  @JsonKey(name: 'loaded_by_user')
  final String? loadedByUser;
  @override
  @JsonKey(name: 'status')
  final String? status;
  @override
  @JsonKey(name: 'linked_transporter_confirmation')
  final String? linkedTransporterConfirmation;
  @override
  @JsonKey(name: 'vehicle_number')
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$LoadingCnfmFormImpl &&
            ...
            (identical(
                  other.vehicleReportingEntryVreDate,
                  vehicleReportingEntryVreDate,
                ) ||
                other.vehicleReportingEntryVreDate ==
                    vehicleReportingEntryVreDate) &&
            ...
            (identical(other.arrivalDateAndTime, arrivalDateAndTime) ||
                other.arrivalDateAndTime == arrivalDateAndTime) &&
            (identical(other.driverIdPhoto, driverIdPhoto) ||
                other.driverIdPhoto == driverIdPhoto) &&
            (identical(other.loadedByUser, loadedByUser) ||
                other.loadedByUser == loadedByUser) &&
            (identical(other.status, status) || other.status == status) &&
            (identical(
                  other.linkedTransporterConfirmation,
                  linkedTransporterConfirmation,
                ) ||
                other.linkedTransporterConfirmation ==
                    linkedTransporterConfirmation) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$LoadingCnfmFormImplCopyWith<_$LoadingCnfmFormImpl> get copyWith =>
      __$$LoadingCnfmFormImplCopyWithImpl<_$LoadingCnfmFormImpl>(
        this,
        _$identity,
      );
  ...
  Map<String, dynamic> toJson() {
    return _$$LoadingCnfmFormImplToJson(this);
  }
}

abstract class _LoadingCnfmForm implements LoadingCnfmForm {
  const factory _LoadingCnfmForm({
    @JsonKey(name: 'name') final String? name,
    @JsonKey(name: 'owner') final String? owner,
    @JsonKey(name: 'creation', defaultValue: '') final String? creation,
    @JsonKey(name: 'modified', defaultValue: '') final String? modified,
    ...
    @JsonKey(name: 'loaded_by_user') final String? loadedByUser,
  ...
  factory _LoadingCnfmForm.fromJson(Map<String, dynamic> json) =
      _$LoadingCnfmFormImpl.fromJson;
  ...
  @override
  @JsonKey(name: 'driver_id_proof')
  String? get driverIdPhoto;
  @override
  @JsonKey(name: 'loaded_by_user')
  String? get loadedByUser;
  @override
  @JsonKey(name: 'status')
  String? get status;
  @override
