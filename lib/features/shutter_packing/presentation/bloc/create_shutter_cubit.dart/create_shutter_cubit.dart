...
//   //   if (seqNo > totalQty) {
//   //   _emitError(
//   //     Pair('Shutter $seqNo is out of range for total quantity $totalQty.', null),
//   //   );
//   //   return;
//   // }
...
//   // Guards against overlapping create/update calls if scans fire quickly.
...
//         // First line added -> create the doc on the server.
//         // Every subsequent line -> update the existing doc.
//         await _syncLineToServer();
//       },
//     );
//   }

//   /// Pushes the just-added line(s) to the server:
//   /// - If no document exists yet, calls createShutter with all current lines
//   ///   (this is effectively "first row added").
//   /// - If a document already exists, calls updateShutter with only the
//   ///   lines that haven't been synced yet (state.newLines), then clears them.
...
//             emitSafeState(
//               state.copyWith(
//                 form: state.form.copyWith(name: r.second, status: 'Draft'),
//                 newLines: [],
//               ),
//             );
//           },
