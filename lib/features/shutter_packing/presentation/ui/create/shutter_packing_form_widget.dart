...
class ShutterPackingFormWidget extends StatefulWidget {
  const ShutterPackingFormWidget({
    super.key,
...
class __ShutterPackingFormWidgetState extends State<ShutterPackingFormWidget> {
        ...
        BlocListener<ShutterLinesCubit, ShutterLinesCubitState>(
          ...
          listener: (_, state) {
            state.maybeWhen(
              orElse: () {},
              success: (lines) {
                context.cubit<CreateShutterCubit>().addAllLines(lines);
              },
            );
          },
        ),
                            ...
                            child: SearchDropDownList<PalletCodeModel>(
                              ...
                              onSelected: (selected) {
                                context
                                    ...
                                    .onValueChanged(palletCode: selected.name);
                              },
                            ),
                          ),
                          if (!isDropdownLocked)
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    'The sticker will be printed automatically.',
  ...
  Future<void> _scanPalletCode(BuildContext context) async {
    ...
    context.read<CreateShutterCubit>().onValueChanged(palletCode: matchedCode);
  }
  ...
  Future<void> _onUploadImage(BuildContext context) async {
    ...
    await context.cubit<CreateShutterCubit>().onQrScanned(
      extracted,
