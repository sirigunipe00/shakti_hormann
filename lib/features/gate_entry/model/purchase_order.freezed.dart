...
abstract class $PurchaseOrderCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: 'purchase_order') String? name});
}
...
class _$PurchaseOrderImpl implements _PurchaseOrder {
  const _$PurchaseOrderImpl({@JsonKey(name: 'purchase_order') this.name});
...
abstract class _PurchaseOrder implements PurchaseOrder {
  const factory _PurchaseOrder({
    @JsonKey(name: 'purchase_order') final String? name,
  }) = _$PurchaseOrderImpl;
