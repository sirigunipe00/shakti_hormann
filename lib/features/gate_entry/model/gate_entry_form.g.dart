...
_$GateEntryFormImpl _$$GateEntryFormImplFromJson(Map<String, dynamic> json) =>
    _$GateEntryFormImpl(
      ...
      purchaseOrder:
          (json['purchase_orders'] as List<dynamic>?)
      ...
      gateExitDateandTime: json['gate_exit_datetime'] as String?,
      invoicePhotos: _stringOrListToStringList(json['vendor_invoice_photo']),
...
Map<String, dynamic> _$$GateEntryFormImplToJson(_$GateEntryFormImpl instance) =>
    <String, dynamic>{
      ...
      'purchase_orders': instance.purchaseOrder,
      ...
      'gate_exit_datetime': instance.gateExitDateandTime,
      'vendor_invoice_photo': instance.invoicePhotos,
      'vehicle_back_photo': instance.vehicleBackPhoto,
      'gate_number': instance.gateNumber,
    };
